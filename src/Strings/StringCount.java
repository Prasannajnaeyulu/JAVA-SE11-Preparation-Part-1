...
public class StringCount {
    public static void main(String[] args) {
        ...
        System.out.println("1.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); //true

        stringReplaced = stringOriginal.replace("CC", "aa");
        System.out.println("2.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); //true as no "CC" in stringOriginal stringReplaced gets same value as Original
        ...
        System.out.println("5.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); // true as there won't be any change to stringOriginal
        ...
        System.out.println("6.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); // false. there won't be any changes to stringOriginal but still it returns false
                                                     // May be because of Strings for replacements changing immutable object and creating new one

        stringReplaced = stringOriginal.replaceAll("a", "a");
        System.out.println("7.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); //false same rules as described above applies here
        ...
        System.out.println("9.  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced)); // true there won't be any change to stringOriginal
